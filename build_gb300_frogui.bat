...
copy /Y "%MULTICORE_DIR%\linker_scripts\bisrv_GB300_V2-core.ld" "%UAE_DIR%" >nul
...
wsl -e bash -c "cd '%WSL_UAE_PATH%' && chmod +x link_multicore.sh && ./link_multicore.sh GB300V2"
